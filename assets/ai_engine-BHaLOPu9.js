async function e(e = {}) {
	...
	function R() {
		return r.locateFile ? (e = "ai_engine.wasm", r.locateFile ? r.locateFile(e, u) : u + e) : new URL("" + new URL("ai_engine-C4dB-a7U.wasm", import.meta.url).href, "" + import.meta.url).href;
		var e;
	}
	async function x(e) {
		if (!d) try {
